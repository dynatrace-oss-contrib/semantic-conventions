...
[EventName](https://github.com/open-telemetry/opentelemetry-specification/tree/v1.42.0/specification/logs/data-model.md#field-eventname) MUST be`session.start`
...
[EventName](https://github.com/open-telemetry/opentelemetry-specification/tree/v1.42.0/specification/logs/data-model.md#field-eventname) MUST be `session.end`
